...
## 6) Куда загрузить CSV для приоритизации

После экспорта открой:

- `https://lpo2010.github.io/saved-prioritizer-web/`

И загрузи файл `saved_export_*.csv` в интерфейс, чтобы получить приоритизацию по метрикам и свежести.

## 7) Как читать статус в popup
...
## 9) Ограничения parser-only режима
